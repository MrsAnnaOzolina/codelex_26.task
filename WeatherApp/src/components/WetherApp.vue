...
let value = "Dobele"
const data = ref({} as CityData)
const data1 = ref({} as CityDataCurrent)
const data2 = ref({})
const co = ref(0)
const pm2_5 = ref(0)
const pm10 = ref(0)
    ...
    <div class="uk-card uk-card-hover uk-card-secondary .uk-align-center card">
      <div class="card__first">
        <div class="card__box">
          ...
          <p class="card--subtitle">Feels like {{ toggle ? data1.feelslike_f : data1.feelslike_c }} {{ toggle ? "°F" :
            "°C"
          }} </p>
        </div>
      </div>
